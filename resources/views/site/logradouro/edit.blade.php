...
@section('content')
    ...
    <form action="{{route("logradouro.update",$logradouro->id)}}" method="post" id="form_logradouro">
        @method('PUT')
        @csrf
        <div class="card mt-3">
        ...
        <div class="text-center">
            <button class="btn-lg btn-outline-primary cadastra_logradouro mt-4">Atualizar</button>
        </div>
    </form>
